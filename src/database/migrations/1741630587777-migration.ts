...
export class Migration1741630587777 implements MigrationInterface {
    name = 'Migration1741630587777'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "villa_feature_pivot" ADD "policy_id" uuid`);
        ...
        await queryRunner.query(`ALTER TABLE "villa_feature_pivot" ADD CONSTRAINT "FK_ae30a9ea8000ddcafb32d982efb" FOREIGN KEY ("policy_id") REFERENCES "villa_policies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "villa_feature_pivot" DROP CONSTRAINT "FK_ae30a9ea8000ddcafb32d982efb"`);
        ...
        await queryRunner.query(`ALTER TABLE "villa_feature_pivot" DROP COLUMN "policy_id"`);
