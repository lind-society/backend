...
export enum DirectDebitChannelCodeEnum {
...
export class DirectDebitChannelPropertiesDto
  implements DirectDebitChannelProperties
{
  @IsString()
  @IsOptional()
...
export class DirectDebitParametersDto implements DirectDebitParameters {
  @IsEnum(DirectDebitChannelCodeEnum)
  @IsNotEmpty()
  channelCode!: DirectDebitChannelCode;

  @IsObject()
  @ValidateNested({ each: true })
  @Type(() => DirectDebitChannelPropertiesDto)
  @IsOptional()
  channelProperties: DirectDebitChannelProperties;
}
