...
export const envValues: EnvironmentVariables = {
  ...
  WHATSAPP_BROWSER_EXECUTABLE_PATH_UBUNTU: process.env.WHATSAPP_BROWSER_EXECUTABLE_PATH_UBUNTU || '',
  WHATSAPP_BROWSER_EXECUTABLE_PATH_WINDOWS: process.env.WHATSAPP_BROWSER_EXECUTABLE_PATH_WINDOWS || '',
};
