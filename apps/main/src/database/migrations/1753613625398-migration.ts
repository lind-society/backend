...
export class Migration1753613625398 implements MigrationInterface {
    name = 'Migration1753613625398'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "properties" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "secondary_name" character varying NOT NULL, "price" numeric(15,2) NOT NULL, "discount_type" "public"."discount_type_enum", "discount" numeric(15,2), "price_after_discount" numeric(15,2) GENERATED ALWAYS AS (
      CASE 
        WHEN discount_type = 'fixed' THEN 
          GREATEST(price - COALESCE(discount, 0), 0)
        ELSE 
      ...
      END
        ...
        await queryRunner.query(`CREATE TABLE "activities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "secondary_name" character varying NOT NULL, "highlight" text NOT NULL, "price" numeric(15,2) NOT NULL, "discount_type" "public"."discount_type_enum", "discount" numeric(15,2), "price_after_discount" numeric(15,2) GENERATED ALWAYS AS (
      CASE 
        WHEN discount_type = 'fixed' THEN 
          GREATEST(price - COALESCE(discount, 0), 0)
        ELSE 
      ...
      END
        ...
        await queryRunner.query(`CREATE TYPE "public"."booking_payments_status_enum" AS ENUM('pending', 'paid', 'expired', 'authorized', 'canceled', 'failed')`);
        await queryRunner.query(`CREATE TABLE "booking_payments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "payment_method" character varying, "payment_channel" character varying, "amount" numeric(15,2), "status" "public"."booking_payments_status_enum", "paid_at" TIMESTAMP, "payment_reference_id" character varying, "failure_reason" character varying, "currency_id" uuid NOT NULL, "booking_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_4f54ffc7dfddb70234fb53a97a9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."villa_price_rules_season_enum" AS ENUM('Regular Season', 'Low Season', 'High Season', 'Peak Season')`);
        await queryRunner.query(`CREATE TABLE "villa_price_rules" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" text, "start_date" TIMESTAMP WITH TIME ZONE NOT NULL, "end_date" TIMESTAMP WITH TIME ZONE NOT NULL, "season" "public"."villa_price_rules_season_enum" NOT NULL, "is_discount" boolean NOT NULL DEFAULT false, "discount_type" "public"."discount_type_enum", "discount" numeric(15,2), "is_active" boolean NOT NULL DEFAULT true, "currency_id" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_b404da045d21db6c1ca00da7ef9" PRIMARY KEY ("id"))`);
