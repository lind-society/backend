...
export class Migration1757274398936 implements MigrationInterface {
    name = 'Migration1757274398936'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        CASE 
          ...
          ELSE 
            GREATEST(price - (price * COALESCE(discount, 0) / 100), 0)
        END
      ) STORED, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_5c1e336df2f4a7051e5bf08a941" PRIMARY KEY ("id"))`);
      ...
      END
        ...
        await queryRunner.query(`CREATE TABLE "reviews" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "rating" numeric(5,2) NOT NULL, "message" text NOT NULL, "booking_id" uuid, "activity_id" uuid, "villa_id" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "REL_bbd6ac6e3e6a8f8c6e0e8692d6" UNIQUE ("booking_id"), CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "activities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "secondary_name" character varying NOT NULL, "highlight" text NOT NULL, "discount_type" "public"."activities_discount_type_enum", "discount" numeric(15,2), "price" numeric(15,2) NOT NULL, "price_after_discount" numeric(15,2) GENERATED ALWAYS AS (
      CASE 
        WHEN discount_type = 'fixed' THEN 
          GREATEST(price - COALESCE(discount, 0), 0)
        ELSE 
      ...
      END
        ...
        await queryRunner.query(`CREATE TABLE "bookings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."bookings_type_enum" NOT NULL, "total_guest" integer NOT NULL, "total_amount" numeric(15,2) NOT NULL, "booking_date" TIMESTAMP WITH TIME ZONE, "check_in_date" TIMESTAMP WITH TIME ZONE, "check_out_date" TIMESTAMP WITH TIME ZONE, "status" "public"."bookings_status_enum", "currency_id" uuid NOT NULL, "customer_id" uuid NOT NULL, "activity_id" uuid, "villa_id" uuid, "review_id" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_bee6805982cc1e248e94ce94957" PRIMARY KEY ("id"))`);
      ...
      END
        ...
        await queryRunner.query(`CREATE VIEW "villa_price_rules_view" AS 
    SELECT
      vpr.*,
      (
  ...
  `);
        await queryRunner.query(`INSERT INTO "typeorm_metadata"("database", "schema", "table", "type", "name", "value") VALUES (DEFAULT, $1, DEFAULT, $2, $3, $4)`, ["public","VIEW","villa_price_rules_view","SELECT\n      vpr.*,\n      (\n        SELECT COUNT(vprp.villa_id)\n        FROM villa_price_rule_pivot AS vprp\n        WHERE vprp.price_rule_id = vpr.id\n      ) = (\n        SELECT COUNT(villas.id) FROM villas\n      ) AS is_applied_to_all_villa\n    FROM\n      villa_price_rules AS vpr;"]);
  ...
  `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "schema" = $3`, ["VIEW","villa_price_rules_view","public"]);
        await queryRunner.query(`DROP VIEW "villa_price_rules_view"`);
