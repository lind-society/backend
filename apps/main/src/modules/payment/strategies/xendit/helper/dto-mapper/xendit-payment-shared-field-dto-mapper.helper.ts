import {
  ...
  PaymentActionDto,
  PaymentDetailAuthenticationDataAResDto,
...
import {
  ...
  XenditPaymentDetailAuthenticationDataAResDto,
...
export function mapXenditToGenericPaymentActionDto(
...
export function mapXenditToGenericPaymentDetailAuthenticationDataAResDto(
  payload: XenditPaymentDetailAuthenticationDataAResDto,
): PaymentDetailAuthenticationDataAResDto {
  if (!payload) {
    return;
  }
...
export function mapXenditToGenericPaymentDetailAuthorizationDataDto(
  payload: XenditPaymentDetailAuthorizationDataDto,
): PaymentDetailAuthorizationDataDto {
  if (!payload) {
    return;
  }
...
export function mapXenditToGenericPaymentDetailAuthenticationDataDto(
  payload: XenditPaymentDetailAuthenticationDataDto,
): PaymentDetailAuthenticationDataDto {
  if (!payload) {
    return;
  }
  ...
  return {
    flow: payload.flow,
    aRes: mapXenditToGenericPaymentDetailAuthenticationDataAResDto(
      payload.a_res,
    ),
  };
}
