...
export interface IXenditpaymentLinkConfigurationDto {
  primary_payment_channels?: string[];
}
...
export class XenditPaymentLinkConfigurationDto
  implements IXenditpaymentLinkConfigurationDto
{
  @IsArray()
  @IsString({ each: true })
  @IsOptional()
